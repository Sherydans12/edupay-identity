...
These ADRs turn the Identity architecture into explicit contracts. All twelve records below have explicit owner approval and are authoritative for implementation. Operational tunables and unrelated follow-up decisions remain in the architecture document’s remaining-unresolved section.
...
| [0012](ADR-0012-staff-and-exact-personnel-resolution.md) | STAFF and exact personnel resolution for DIE | Accepted (2026-09-23) |
